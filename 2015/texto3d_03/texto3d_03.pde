...
void draw() {  
    ...
    text("un texto largo", -24, 96, 0);
    text("y otro mas", -24, 96+48, 0);
    ...
    // mueve el punto de origen hacia atras en en eje Z
    // para poder colocar la imagen en la cara de atrás del cubo
    translate(0, 0,-96/2);
    // dibuja una imagen
    image(miImagen,-96/2,-96/2, 96,96);
